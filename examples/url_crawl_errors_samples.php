...
if ($client->getAccessToken()) {
  ...
  $urlcrawlerrorssamples = $webmastersService->urlcrawlerrorssamples;
    ...
    try {
		$url = 'www.kotak.com';				/* Enter site url  */
		$category = 'other';				/* Enter category  */
		$platform = 'web';					/* Enter platform   */
       $response = $urlcrawlerrorssamples->listUrlcrawlerrorssamples('www.kotak.com','other','web');
       echo "<pre>";
       print_r($response);
       echo "</pre>";
    } catch(\Exception $e ) {
